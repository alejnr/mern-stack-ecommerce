...
const OrderScreen = ({ match, history }) => {
  ...
  return loading ? (
    ...
    <>
      <h1 className='sm-fs-20px text-muted'>Ordine #: {order._id}</h1>
      <Row>
        <Meta title={'Ordine | CentCellStore'} />
        <Col md={8}>
          <ListGroup variant='flush'>
            ...
            <ListGroup.Item>
              ...
              {order.isPaid ? (
                <Message variant='success'>Pagato {order.paidAt}</Message>
              ) : (
